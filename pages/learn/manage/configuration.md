...
RESIN_OVERRIDE_LOCK | 0 | When set to 1 overrides any existing [update lock][update-locking] on the device. Allows updating devices in the case that the application locked updates but is stuck in an invalid state. |
